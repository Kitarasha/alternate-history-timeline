        ...
        "476-Падение Римской Империи": [
            {
                ...
                color: "#b2dfdb",
                scenario: [
                    { year: 500, text: "Рим успешно реорганизовал свои провинции, создав эффективную систему управления и налогообложения. Ставка на торговлю, дипломатию и внедрение новых технологий (например, паровых машин на основе ранних разработок Герона Александрийского) обеспечила экономический рост. Империя стала объединяющим центром науки, культуры и медицины." },
                    { year: 600, text: "Рим Благодаря стабильности и развитию инфраструктуры, Рим начал колонизацию Северной Европы и освоение Западной Африки. Появилась система университетов, что ускорило технологические открытия, включая создание примитивных механизмов для облегчения сельского труда." },
					{ year: 800, text: "Изобретение первых прототипов часов, развитие навигации и картографии позволили римлянам отправиться в Новый Свет за 700 лет до Колумба. Это открыло доступ к ресурсам Америки, что укрепило позиции империи на мировой арене." },
                ]
            },
            {
                title: "Империя распалась, но позже",
                color: "#80cbc4",
                scenario: [
                    { year: 476, text: "Германские племена всё же нанесли серьёзный урон Риму, но благодаря объединению с Восточной Империей (Византией), Запад смог стабилизироваться. Варвары постепенно интегрировались в римскую культуру, образовав федеративное государство." },
                    { year: 700, text: "Период "Второго Возрождения". Элементы христианской и римской культуры слились воедино, положив основу для более мощного государства. Этот Рим стал прообразом раннего промышленного общества." },
					{ year: 1200, text: "Вместо феодальной раздробленности, Европа под управлением "Объединённого Рима" выходит на глобальную арену с развитой бюрократией и армией. Первые паровые суда пересекают Средиземное море, начав новую эпоху "римского" империализма. " }
                ]
            },
            {
                title: "Открытие электричества в Риме",
                color: "#4db6ac",
                scenario: [
                    { year: 480, text: "Падение Западной Римской империи не произошло благодаря технологическому прогрессу. Римские инженеры, вдохновлённые работами античных философов (Герона Александрийского, Архимеда), делают открытия в области магнетизма и электричества. В Галлии найдено большое месторождение природного магнетита, который становится основой для изучения электрических явлений." },
                    { year: 550, text: "Рим выходит на новый уровень социального развития благодаря "Электрическому Ренессансу". Улицы крупнейших городов освещены, ночная жизнь бурлит. Для рабочих и крестьян разрабатываются электрические механизмы, облегчающие труд: насосы для полей, мельницы и простые механические подъемники. },
					{ year: 600, text: "Константинополь становится "Электрической столицей мира". Разрабатываются первые прототипы телеграфов для быстрой передачи сообщений между провинциями. Эта технология помогает в управлении огромной империей. " }
                ]
            }
        ]
    };
